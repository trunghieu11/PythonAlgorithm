class Team:
    ...
    def __str__(self):
        return self.name + " " + str(sum(self.rank)) + " " + '{:.1f}'.format(sum(self.scores))
...
class ContestScore:
    def sortResults(self, data):
        ...
        teams = sorted(teams, key=lambda x:(sum(x.rank), -round(sum(x.scores), 1), x.name))
...
# ----- test 0 -----
disabled = False
p0 = ("A 90.7 92.9 87.4", "B 90.5 96.6 88.0", "C 92.2 91.0 95.3")
p1 = ("C 5 278.5", "B 6 275.1", "A 7 271.0")
...
# ----- test 3 -----
disabled = False
p0 = ("ABCDE 99.9 99.9 99.9 99.9 99.9 99.9 99.9 99.9 99.9",)
p1 = ("ABCDE 9 899.1",)
...
# ----- test 6 -----
disabled = False
p0 = ("FFFF 99.9 88.8 77.7 66.6 55.5 44.4 33.3 22.2 11.1", "IIII 88.8 77.7 66.6 55.5 44.4 33.3 22.2 11.1 00.0", "BBBB 77.7 66.6 55.5 44.4 33.3 22.2 11.1 00.0 99.9", "DDDD 66.6 55.5 44.4 33.3 22.2 11.1 00.0 99.9 88.8", "JJJJ 55.5 44.4 33.3 22.2 11.1 00.0 99.9 88.8 77.7", "AAAA 44.4 33.3 22.2 11.1 00.0 99.9 88.8 77.7 66.6", "GGGG 33.3 22.2 11.1 00.0 99.9 88.8 77.7 66.6 55.5", "HHHH 22.2 11.1 00.0 99.9 88.8 77.7 66.6 55.5 44.4", "CCCC 11.1 00.0 99.9 88.8 77.7 66.6 55.5 44.4 33.3", "EEEE 00.0 99.9 88.8 77.7 66.6 55.5 44.4 33.3 22.2")
p1 = ("FFFF 45 499.5", "EEEE 46 488.4", "CCCC 47 477.3", "HHHH 48 466.2", "GGGG 49 455.1", "AAAA 50 444.0", "JJJJ 51 432.9", "DDDD 52 421.8", "BBBB 53 410.7", "IIII 54 399.6")
...
# ----- test 7 -----
disabled = False
p0 = ("AAA 90.0 80.0 70.0 60.0 50.0 40.0", "BBB 80.0 70.0 60.0 50.0 40.0 90.0", "CCC 70.0 60.0 50.0 40.0 90.0 80.0", "DDD 60.0 50.0 40.0 90.0 80.0 70.0", "EEE 50.0 40.0 90.0 80.0 70.0 60.0", "FFF 40.0 90.0 80.0 70.0 60.0 50.0")
p1 = ("AAA 21 390.0", "BBB 21 390.0", "CCC 21 390.0", "DDD 21 390.0", "EEE 21 390.0", "FFF 21 390.0")
...
# ----- test 8 -----
disabled = False
p0 = ("AAA 90.0 80.0 70.0 60.0 50.0 40.0", "BBB 90.0 80.0 70.0 60.0 50.0 40.0", "CCC 90.0 80.0 70.0 60.0 50.0 40.0", "DDD 90.0 80.0 70.0 60.0 50.0 40.0", "EEE 90.0 80.0 70.0 60.0 50.0 40.0", "FFF 90.0 80.0 70.0 60.0 50.0 40.0")
p1 = ("AAA 6 390.0", "BBB 6 390.0", "CCC 6 390.0", "DDD 6 390.0", "EEE 6 390.0", "FFF 6 390.0")
...
# ----- test 9 -----
disabled = False
p0 = ("FFF 90.0 80.0 70.0 60.0 50.0 40.0", "EEE 80.0 70.0 60.0 50.0 40.0 90.0", "DDD 70.0 60.0 50.0 40.0 90.0 80.0", "CCC 60.0 50.0 40.0 90.0 80.0 70.0", "BBB 50.0 40.0 90.0 80.0 70.0 60.0", "AAA 40.0 90.0 80.0 70.0 60.0 50.0")
p1 = ("AAA 21 390.0", "BBB 21 390.0", "CCC 21 390.0", "DDD 21 390.0", "EEE 21 390.0", "FFF 21 390.0")
...
# ----- test 10 -----
disabled = False
p0 = ("AA 90.0 80.0 70.0 60.0 50.0 40.0", "BBB 80.0 70.0 60.0 50.0 40.0 90.0", "EEE 70.0 60.0 50.0 40.0 90.0 80.0", "AAA 60.0 50.0 40.0 90.0 80.0 70.0", "DDD 50.0 40.0 90.0 80.0 70.0 60.0", "CCC 40.0 90.0 80.0 70.0 60.0 50.0")
p1 = ("AA 21 390.0", "AAA 21 390.0", "BBB 21 390.0", "CCC 21 390.0", "DDD 21 390.0", "EEE 21 390.0")
...
# ----- test 26 -----
disabled = False
p0 = ("A 00.1", "B 05.2", "C 29.0", "D 00.0")
p1 = ("C 1 29.0", "B 2 5.2", "A 3 0.1", "D 4 0.0")
...
# ----- test 27 -----
disabled = False
p0 = ("AAAAA 99.0 00.1 01.5 07.7", "BBBBB 98.0 00.2 02.5 06.7", "CCCCC 97.0 00.3 03.5 05.7", "DDDDD 98.0 00.2 04.5 09.7", "EEEEE 99.0 00.1 05.5 09.3")
p1 = ("EEEEE 8 113.9", "DDDDD 8 112.4", "AAAAA 13 108.3", "BBBBB 13 107.4", "CCCCC 14 106.5")
...
p1 = ("KNWO 143 614.9", "SXBB 143 611.6", "GJBK 158 574.0", "AXCG 166 563.1", "ECCJ 171 562.7", "VYEE 175 526.1", "GQXJ 177 543.7", "ELLG 183 527.0", "WCJH 186 537.4", "KRBI 193 510.0", "FIJR 196 503.9", "NZNY 197 501.3", "BOSK 197 488.8", "YXTQ 199 494.9", "LGHO 201 488.9", "DDJP 201 475.3", "VXOF 202 496.0", "SCAU 205 470.2", "DAFV 208 471.0", "FDAH 223 440.8", "ZFWH 224 464.1", "TDCJ 227 428.8", "FJIA 228 447.2", "IPYB 228 413.8", "LIZX 229 419.9", "FTRI 229 415.9", "FGMP 231 430.2", "NWHC 232 421.2", "UGOK 232 409.3", "XKEO 236 412.2", "VUFT 239 398.5", "FKHY 245 392.7", "KRUQ 248 402.8", "CIVB 248 398.9", "PWJG 250 363.3", "VAVD 252 401.0", "STJD 256 385.8", "KXJY 257 383.5", "HPUA 262 364.6", "TFNQ 264 347.8", "XXGJ 266 349.6", "MNPI 275 345.8", "WPRM 280 325.6", "JEJR 281 320.4", "USZQ 284 320.7", "LIQX 286 317.3", "CPRJ 289 309.5", "YOZR 295 315.3", "ZKQE 307 270.6", "VAZS 363 156.7")
...
# ----- test 37 -----
disabled = False
p0 = ("A 99.0 99.0 99.0", "B 98.0 98.0 96.0", "C 97.0 98.0 98.0", "D 96.0 96.0 96.0", "F 95.0 95.0 95.0", "E 95.0 95.0 95.0", "G 00.0 00.0 00.0")
p1 = ("A 3 297.0", "C 7 293.0", "B 7 292.0", "D 11 288.0", "E 15 285.0", "F 15 285.0", "G 21 0.0")
...
# ----- test 39 -----
disabled = False
p0 = ("C 00.3 00.0", "D 00.1 00.2", "A 00.1 00.2", "B 00.3 00.0", "AC 00.6 00.7", "AD 00.5 00.8", "AA 00.5 00.8", "AB 00.6 00.7", "BC 01.3 01.1", "BD 01.2 01.2", "BA 01.2 01.2", "BB 01.3 01.1", "CC 02.1 02.9", "CD 02.4 02.6", "CA 02.4 02.6", "CB 02.1 02.9")
p1 = ("CA 4 5.0", "CB 4 5.0", "CC 4 5.0", "CD 4 5.0", "BA 12 2.4", "BB 12 2.4", "BC 12 2.4", "BD 12 2.4", "AA 20 1.3", "AB 20 1.3", "AC 20 1.3", "AD 20 1.3", "A 28 0.3", "B 28 0.3", "C 28 0.3", "D 28 0.3")
...
p1 = ("MIT 34 721.7", "PRINCETON 34 717.6", "HARVARD 37 719.9", "BROWN 38 720.0", "YALE 38 712.4", "STANFORD 39 711.3", "CORNELL 42 629.3", "COLUMBIA 44 709.0", "PENN 52 691.2")
...
# ----- test 42 -----
disabled = False
p0 = ("B 11.1 11.1 11.1 11.1", "C 17.3 54.7 33.4 22.4", "D 13.3 11.3 33.3 44.4")
p1 = ("C 5 127.8", "D 7 102.3", "B 12 44.4")
...
# ----- test 43 -----
disabled = False
p0 = ("A 50.0 51.0", "B 60.0 50.0")
p1 = ("B 3 110.0", "A 3 101.0")
...
# ----- test 44 -----
disabled = False
p0 = ("A 90.7 92.9 87.4", "B 11.0 11.0 11.0")
p1 = ("A 3 271.0", "B 6 33.0")
...
# ----- test 45 -----
disabled = False
p0 = ("A 10.0", "B 10.0", "C 10.0", "D 09.0", "E 09.0", "F 09.0")
p1 = ("A 1 10.0", "B 1 10.0", "C 1 10.0", "D 4 9.0", "E 4 9.0", "F 4 9.0")
...
# ----- test 46 -----
disabled = False
p0 = ("A 80.4", "B 92.0", "C 92.0", "D 95.0")
p1 = ("D 1 95.0", "B 2 92.0", "C 2 92.0", "A 4 80.4")
...
# ----- test 47 -----
disabled = False
p0 = ("A 98.3 97.4 93.2 90.8", "B 99.1 94.7 93.2 98.2", "C 90.9 95.2 90.0 99.1", "D 20.1 21.3 99.0 10.2")
p1 = ("B 8 385.2", "A 8 379.7", "C 10 375.2", "D 13 150.6")
...
# ----- test 48 -----
disabled = False
p0 = ("A 10.0 30.0", "B 20.0 25.0")
p1 = ("B 3 45.0", "A 3 40.0")
...
# ----- test 50 -----
disabled = False
p0 = ("D 11.1 11.1 11.1", "C 11.1 11.1 11.1", "B 11.2 11.2 11.2", "A 11.1 11.1 11.1")
p1 = ("B 3 33.6", "A 6 33.3", "C 6 33.3", "D 6 33.3")
...
# ----- test 51 -----
disabled = False
p0 = ("AA 90.0 80.0 70.0 60.0 50.0 40.0", "BBB 80.0 70.0 60.0 50.0 40.0 90.0", "EEE 70.0 60.0 50.0 40.0 90.0 80.0")
p1 = ("AA 9 390.0", "BBB 12 390.0", "EEE 15 390.0")
